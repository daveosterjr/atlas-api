...
class LLMService
{
     ...
     */
    public function __construct(string $apiKey, string $provider = 'openai', string $defaultModel = 'gpt-4o-mini')
    {
        $this->apiKey = $apiKey;
     ...
     */
    public function askForJson(string $question, array $schema, ?array $imageUrls = null, ?string $model = null): array
    {
        ...
        $prompt = $question . "\n\nRespond with a valid JSON object matching this schema: " . json_encode($schema);
     ...
     */
    public function askYesNo(string $question, ?array $imageUrls = null, ?string $model = null): bool
    {
     ...
     * @return string The response text
     */
    private function sendRequest(?string $model = null): string
    {
        $model = $model ?? $this->defaultModel;
     ...
     * @return string The response text
     */
    public function askWithSearch(string $question, ?string $model = 'gpt-4o-search-preview', ?array $imageUrls = null): string
    {
     ...
     * @return array The JSON response as an associative array
     */
    public function askForJsonWithSearch(string $question, array $schema, ?string $model = 'gpt-4o-search-preview', ?array $imageUrls = null): array
    {
        // Verify the model supports search
        $searchModel = $model ?? 'gpt-4o-search-preview';
        if (!$this->providers[$this->provider]->supportsSearch($searchModel)) {
